...
from riab.calculations.models import Calculation
import sys
import os
import traceback
import inspect
import string
from riab_server.function.plugins import get_function

logger = logging.getLogger("riab.utilities")
...
def calculation_save(filename, user, title, metadata):
    ...
    layer = simple_save(filename, theuser, title, overwrite=False)
