...
class PadangEarthquakeBuildingDamageFunction(FunctionProvider):
	...
	for i in range(len(shaking)):
	    ...
	    percent_damage = scipy.stats.lognorm.cdf(mmi,damage_params['beta'],scale=damage_params['median'])*100
	    building_damage.append({'Percent_damage': percent_damage, 'MMI': mmi, 'Building_Class':building_class}) #, 'Building_Id': building_id })
