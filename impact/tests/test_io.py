    ...
    def test_centroids_from_polygon_data(self):
        ...
        for vectorname in ['kecamatan_geo.shp',
            ...
            if os.path.isfile(filename):
                ...
                # Make test can continue in case reference data isn't there
                # In case of the OSM data, qgis crashed when trying to
                # make it.
                r_attributes = p_attributes
                r_geometry = p_geometry
            ...
            for i in range(N):
                ...
                numpy.allclose(c_geom, r_geom, rtol=0, atol=1.0e-10)
